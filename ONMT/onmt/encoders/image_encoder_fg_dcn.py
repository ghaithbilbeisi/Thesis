...
class ImageEncoder(EncoderBase):
    ...
    def __init__(self, num_layers, bidirectional, rnn_size, dropout,
        ...
        #                        padding=(1, 1), stride=(1, 1))
        self.layer8 = DCN(128, 128, kernel_size=(2,2), padding=(1,1), stride=(1,1), deformable_groups=2).cuda()
        #self.layer9 = nn.Conv2d(128, 128, kernel_size=(2, 2),
        #                        padding=(1, 1), stride=(1, 1))
        self.layer9 = DCN(128, 128, kernel_size=(2,2), padding=(1,1), stride=(1,1), deformable_groups=2).cuda()
        #self.layer10 = nn.Conv2d(128, 128, kernel_size=(2, 2),
        #                        padding=(1, 1), stride=(1, 1))
        self.layer10 = DCN(128, 128, kernel_size=(2,2), padding=(1,1), stride=(1,1), deformable_groups=2).cuda()
