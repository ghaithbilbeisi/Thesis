...
class ImageEncoder(EncoderBase):
    ...
    def __init__(self, num_layers, bidirectional, rnn_size, dropout,
        ...
        #                        padding=(1, 1), stride=(1, 1))
        self.layer4 = DCN(256, 256, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), dilation=1, deformable_groups=2).cuda()
        #self.layer5 = nn.Conv2d(256, 512, kernel_size=(3, 3),
        #                        padding=(1, 1), stride=(1, 1))
        self.layer5 = DCN(256, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), dilation=1, deformable_groups=2).cuda()
        #self.layer6 = nn.Conv2d(512, 512, kernel_size=(3, 3),
        #                        padding=(1, 1), stride=(1, 1))
        self.layer6 = DCN(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), dilation=1, deformable_groups=2).cuda()
