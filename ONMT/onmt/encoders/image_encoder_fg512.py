...
class ImageEncoder(EncoderBase):
    ...
    def __init__(self, num_layers, bidirectional, rnn_size, dropout,
        ...
        self.layer5 = nn.Conv2d(128, 128, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        self.layer6 = nn.Conv2d(128, 256, kernel_size=(3, 3),
                                padding=(1, 1), stride=(1, 1))
        ## Block 3
        self.layer7 = nn.Conv2d(256, 256, kernel_size=(2, 2),
                                padding=(1, 1), stride=(1, 1))
        self.layer8 = nn.Conv2d(256, 256, kernel_size=(2, 2),
                                padding=(1, 1), stride=(1, 1))
        self.layer9 = nn.Conv2d(256, 512, kernel_size=(2, 2),
                                padding=(1, 1), stride=(1, 1))
        self.layer10 = nn.Conv2d(512, 512, kernel_size=(2, 2),
                                padding=(1, 1), stride=(1, 1))
